...
const VIDEOS = [
  ...
  { id:"ii9EQ3j5pWo", ch:"02", title:"Discover Africa",     tag:"Documentary",    desc:"We travelled to northern Tanzania near Lake Eyasi to document the Hadzabe people — one of the world's last surviving hunter-gatherer communities.", extra:"The Hadzabe are often viewed as 'primitive' or 'stuck in the past,' but in reality they possess deep knowledge of nature, sustainable living practices, and a unique culture that has survived for thousands of years. At the same time, they face modern challenges such as land loss and cultural change. Our documentary — 'The Hadzabe Tribe: Tanzania's Last Hunter-Gatherers' — brings their story to light." },
  { id:"Z7f2ABngBQ4", ch:"03", title:"HELP-LAB",            tag:"Community",      desc:"Small acts of kindness — our team visited a local hospital, delivering food and covering medicine payments for sick patients who could not afford care.", extra:"This challenge reinforced our belief that meaningful change starts with small, consistent acts of kindness to those around us. The Citrus_alu team organised a community visit, gathering supplies and spending time with patients at a local hospital.", photos:["/assets/helplab-1.jpg","/assets/helplab-2.jpg","/assets/helplab-3.jpg"] },
  { id:"5a_KFzYQeq4", ch:"04", title:"Hunt for Treasure",   tag:"Interview",      desc:"We interviewed Jobra — an AI-powered African workforce platform — to understand how technology can bridge the youth employment gap.", extra:"Jobra (evolved from Rwanda's first talent marketplace, Umurava) connects companies with vetted African talent through sourcing, screening, assessments, and training. Their three core barriers mirror ours: skills mismatch, limited networks, and lack of work experience.", photos:["/assets/jobra-visit-1.jpg","/assets/jobra-visit-2.jpg"], partnerLogo:"/assets/jobra.png" },
  ...
  { id:"JJOUycjgGy0", ch:"06", title:"Solution",            tag:"Documentation",  isSolution:true },
];
